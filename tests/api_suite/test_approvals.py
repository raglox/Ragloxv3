...
class TestMissionApprovals:
    ...
    def test_list_pending_approvals_success(self, client: httpx.Client, created_mission: Dict[str, Any]) -> None:
    ...
    def test_list_pending_approvals_empty(self, client: httpx.Client, created_mission: Dict[str, Any]) -> None:
    ...
    def test_list_pending_approvals_not_found(self, client: httpx.Client, mission_id: str) -> None:
        """Test that listing approvals for non-existent mission returns 404."""
        response = client.get(f"/api/v1/missions/{mission_id}/approvals")
        assert response.status_code == 404

    def test_approve_action_success(self, client: httpx.Client, created_mission: Dict[str, Any], 
        ...
        response = client.post(f"/api/v1/missions/{mission_id}/approve/{action_id}", json=sample_approval_request)
    ...
    def test_approve_action_not_found(self, client: httpx.Client, created_mission: Dict[str, Any], 
                                     sample_approval_request: Dict[str, Any], action_id: str) -> None:
    ...
    def test_approve_action_mission_not_found(self, client: httpx.Client, mission_id: str, 
                                             sample_approval_request: Dict[str, Any], action_id: str) -> None:
        """Test that approving an action for non-existent mission returns 404."""
        response = client.post(f"/api/v1/missions/{mission_id}/approve/{action_id}", json=sample_approval_request)
        assert response.status_code == 404

    def test_reject_action_success(self, client: httpx.Client, created_mission: Dict[str, Any], 
        ...
        mission_id = created_mission["mission_id"]
        # For a new mission, this action_id won't exist, so we expect 404
        response = client.post(f"/api/v1/missions/{mission_id}/reject/{action_id}", json=sample_rejection_request)
        # Should be 404 for non-existent action or 200 if action exists
        assert response.status_code in [200, 404]
    ...
    def test_reject_action_not_found(self, client: httpx.Client, created_mission: Dict[str, Any], 
                                    sample_rejection_request: Dict[str, Any], action_id: str) -> None:
    ...
    def test_reject_action_mission_not_found(self, client: httpx.Client, mission_id: str, 
                                           sample_rejection_request: Dict[str, Any], action_id: str) -> None:
        """Test that rejecting an action for non-existent mission returns 404."""
        response = client.post(f"/api/v1/missions/{mission_id}/reject/{action_id}", json=sample_rejection_request)
        assert response.status_code == 404

    def test_approve_action_validation_error(self, client: httpx.Client, created_mission: Dict[str, Any], 
                                            action_id: str) -> None:
    ...
    def test_reject_action_validation_error(self, client: httpx.Client, created_mission: Dict[str, Any], 
                                           action_id: str) -> None:
...
class TestApprovalWorkflow:
    ...
    def test_approval_workflow(self, client: httpx.Client, running_mission: Dict[str, Any]) -> None:
