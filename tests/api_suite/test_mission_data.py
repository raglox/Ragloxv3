...
class TestMissionTargets:
    ...
    def test_list_targets_success(self, authenticated_client: httpx.Client, created_mission: Dict[str, Any]) -> None:
        """Test that GET /api/v1/missions/{mission_id}/targets returns 200 OK."""
        mission_id = created_mission["mission_id"]
        response = authenticated_client.get(f"/api/v1/missions/{mission_id}/targets")
    ...
    def test_list_targets_empty(self, authenticated_client: httpx.Client, created_mission: Dict[str, Any]) -> None:
    ...
    def test_list_targets_not_found(self, authenticated_client: httpx.Client, mission_id: str) -> None:
        """Test that listing targets for non-existent mission returns 404."""
        response = authenticated_client.get(f"/api/v1/missions/{mission_id}/targets")
        assert response.status_code == 404

    def test_get_target_success(self, authenticated_client: httpx.Client, created_mission: Dict[str, Any], target_id: str) -> None:
        ...
        response = authenticated_client.get(f"/api/v1/missions/{mission_id}/targets/{target_id}")
    ...
    def test_get_target_not_found(self, authenticated_client: httpx.Client, created_mission: Dict[str, Any], target_id: str) -> None:
        """Test that getting a non-existent target returns 404."""
        mission_id = created_mission["mission_id"]
        response = authenticated_client.get(f"/api/v1/missions/{mission_id}/targets/{target_id}")
        assert response.status_code == 404

    def test_get_target_mission_not_found(self, authenticated_client: httpx.Client, mission_id: str, target_id: str) -> None:
...
class TestMissionVulnerabilities:
    ...
    def test_list_vulnerabilities_success(self, authenticated_client: httpx.Client, created_mission: Dict[str, Any]) -> None:
        """Test that GET /api/v1/missions/{mission_id}/vulnerabilities returns 200 OK."""
        mission_id = created_mission["mission_id"]
        response = authenticated_client.get(f"/api/v1/missions/{mission_id}/vulnerabilities")
        assert response.status_code == 200
        data = response.json()
        assert isinstance(data, list)
    ...
    def test_list_vulnerabilities_empty(self, authenticated_client: httpx.Client, created_mission: Dict[str, Any]) -> None:
    ...
    def test_list_vulnerabilities_not_found(self, authenticated_client: httpx.Client, mission_id: str) -> None:
...
class TestMissionCredentials:
    ...
    def test_list_credentials_success(self, authenticated_client: httpx.Client, created_mission: Dict[str, Any]) -> None:
        """Test that GET /api/v1/missions/{mission_id}/credentials returns 200 OK."""
        mission_id = created_mission["mission_id"]
        response = authenticated_client.get(f"/api/v1/missions/{mission_id}/credentials")
        assert response.status_code == 200
        data = response.json()
        assert isinstance(data, list)
    ...
    def test_list_credentials_empty(self, authenticated_client: httpx.Client, created_mission: Dict[str, Any]) -> None:
    ...
    def test_list_credentials_not_found(self, authenticated_client: httpx.Client, mission_id: str) -> None:
...
class TestMissionSessions:
    ...
    def test_list_sessions_success(self, authenticated_client: httpx.Client, created_mission: Dict[str, Any]) -> None:
        """Test that GET /api/v1/missions/{mission_id}/sessions returns 200 OK."""
        mission_id = created_mission["mission_id"]
        response = authenticated_client.get(f"/api/v1/missions/{mission_id}/sessions")
        assert response.status_code == 200
        data = response.json()
        assert isinstance(data, list)
    ...
    def test_list_sessions_empty(self, authenticated_client: httpx.Client, created_mission: Dict[str, Any]) -> None:
    ...
    def test_list_sessions_not_found(self, authenticated_client: httpx.Client, mission_id: str) -> None:
...
class TestMissionStats:
    ...
    def test_get_mission_stats_success(self, authenticated_client: httpx.Client, created_mission: Dict[str, Any]) -> None:
        """Test that GET /api/v1/missions/{mission_id}/stats returns 200 OK."""
        mission_id = created_mission["mission_id"]
        response = authenticated_client.get(f"/api/v1/missions/{mission_id}/stats")
        assert response.status_code == 200
        data = response.json()
    ...
    def test_get_mission_stats_not_found(self, authenticated_client: httpx.Client, mission_id: str) -> None:
...
class TestMissionDataWorkflow:
    ...
    def test_mission_data_polling_workflow(self, authenticated_client: httpx.Client, running_mission: Dict[str, Any]) -> None:
